...
class Index extends Common
{
    public function index()
    {
        ...
        //健身问答
        $jswd=db('content a')->field("a.id,a.title,a.keywords,a.description,a.shortnote,a.ctime,a.catid,a.modelid,a.status,a.picurl,b.cid,b.note")->join('news_data b','a.id=b.cid','inner')->where('catid=5')->order('ctime desc')->limit(5)->select();
        $this->assign('jswd',$jswd);
