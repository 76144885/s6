<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"F:\web\s6\public/../admin/index\view\category\edit.html";i:1526304339;s:53:"F:\web\s6\public/../admin/index\view\common\base.html";i:1522602180;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="fid" class="select">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($rinfo['fid'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['title']; ?></option>
...
&nbsp;&nbsp;&nbsp;&nbsp;|-<?php echo $voo['title']; ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $rinfo['keyword']; ?>" placeholder="" id="keyword" name="keyword">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $rinfo['tags']; ?>" placeholder="" id="tags" name="tags">
			</div>
		</div>
		<div class="row cl">
